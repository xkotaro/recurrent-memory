...
from model.model import RecurrentNetTimeFixedOnlyRec
...
def main():
    ...
    model = RecurrentNetTimeFixedOnlyRec(n_in=200, n_hid=args.network_size, n_out=1,
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if args.save_model and (epoch - 1) % args.savepoint == 0:
            ...
            torch.save(model.state_dict(),
                       "/root/models/{}_wo_input_layer_netsize_{}_stimdur_{}_nstim_{}_respdur_{}_epoch_{}.pth"
